...
export const AdminMenu = () => {
  ...
  const menuItems = [
    ...
    { label: "Manage", icon: <SettingFilled />, key: null, children: [{label: "Users", icon: <UserOutlined />, key: 'usersManage'}, {label: "Slots", icon: <NotificationOutlined />, key: 'slotsManage'}, {label: "Bookings", icon: <SnippetsOutlined />, key: 'bookingsManage'},]}
